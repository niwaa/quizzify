/**
 * @file Utility library with word vector data.
 * Credit to https://github.com/turbomaze/word2vecjson
 */
...
const wordvecUtils = {}
const wordVecs = require('../data/wordvecs10000')
...
wordvecUtils.findSimilarWords = findSimilarWords
module.exports = wordvecUtils
